...
public class AppointmentTest {
    ...
    public void testAddContact() {
        ...
        try {
            contactAppointment.addContact(Bob);
        } catch (Exception e) {
            contactAdded = false;
        }
        assertTrue(contactAdded);
        assertFalse(contactAppointment.addContact(Bob));
        // TODO review the generated test code and remove the default call to fail.
        fail("Adding contact failed/readding contact succeeded, which it shouldnt.");
    }
