...
public class TimeSpan2Test {
    ...
    @Test
    public void TestTimeSpan2Constructor ()
    {
        ...
        TimeSpan2 timeSpan2 = null;
        try {
            timeSpan2 = new TimeSpan2(time2, time1);
        } catch (Exception e) {
            //error
        }
    ...
    public void TestTimeSpan2SetBeginTime()
    {
        ...
        TimeSpan2 timeSpan2 = new TimeSpan2(time4, time5);
    ...
    public void TestTimeSpan2SetEndTime()
    {
        ...
        assertEquals("De eindtijd is niet veranderd" + timeSpan2.getEndTime().getYear(), timeSpan2.getEndTime(), time6);
    }        
    ...
    @Test
    public void TestTimeSpan2ChangeLengthWith()
    {
        // TEST 1 (verlengen)
        Time time1 = new Time(1995, 7, 11, 0,0);
        Time time2 = new Time(1996, 7, 11, 0,10);
        ...
        TimeSpan2 timeSpan2 = new TimeSpan2(time1, time3);
    ...
    public void TestTimeSpan2IsPartOf()
    {
        ...
        Time time6 = new Time(1996, 7, 11, 0,0);
        TimeSpan2 timeSpan3 = new TimeSpan2(time5, time6);
        
        Time time7 = new Time(1997, 7, 11, 0,0);
        Time time8 = new Time(1998, 7, 11, 0,0);
        TimeSpan2 timeSpan4 = new TimeSpan2(time7, time8);
    ...
    public void TestTimeSpan2UnionWith()
    {
        ...
        TimeSpan2 timeSpan7 = new TimeSpan2(time13, time14);
    ...
    @Test
    public void TestTimeSpan2IntersectionWith ()
    {
        // TEST 1 (in elkaar)
        Time time1 = new Time(1995, 7, 11, 0,0);
    ...
    @Test
    public void TestTimeSpan2Equals ()
    {
        Time time1 = new Time(1995, 7, 11, 0,0);
        Time time2 = new Time(1997, 7, 11, 0,0);
        TimeSpan2 timeSpan1 = new TimeSpan2(time1, time2);
